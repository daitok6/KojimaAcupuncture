...
export const translations = {
  ...
  ja: {
    ...
    home: {
      ...
      intro: "当院へお越しいただきありがとうございます。当院では、患者様お一人お一人の体質や症状に合わせたオーダーメイドの治療プログラムをご提供しております。長野式、松本岐子式、そして長年の経験に基づく独自の手法を組み合わせ、様々な症状に対応いたします。今まで色々試してみたが、改善が見られない方も、お気軽にご相談ください。",
      location: "所在地",
      address: "40 Wynford Drive # 301 Toronto, Ontario",
      parking: "駐車場",
