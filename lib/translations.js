...
export const translations = {
  en: {
    ...
    home: {
      ...
      intro: "Thank you for visiting our clinic. We create personalized treatment programs tailored to each patient's unique needs.",
      introBullets: [
        { icon: "🎯", text: "Personalized to your constitution & condition" },
        { icon: "🌿", text: "Nagano style · Kiiko Matsumoto style · experience-based methods" },
        { icon: "💬", text: "No improvement? We're always here to consult" },
      ],
      location: "Location",
  ...
  ja: {
    ...
    home: {
      ...
      intro: "当院へお越しいただきありがとうございます。患者様お一人お一人の体質や症状に合わせた、オーダーメイドの治療プログラムをご提供しております。",
      introBullets: [
        { icon: "🎯", text: "体質・症状に合わせた個別対応" },
        { icon: "🌿", text: "長野式・松本岐子式・経験則に基づく独自手法" },
        { icon: "💬", text: "色々と試してみたが、改善が見られない方も、お気軽にご相談ください" },
      ],
      location: "所在地",
      address: "40 Wynford Drive # 301 Toronto, Ontario",
      parking: "駐車場",
